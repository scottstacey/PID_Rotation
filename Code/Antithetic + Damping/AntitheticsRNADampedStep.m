function AntitheticsRNADampedStep
clear; clc; clf;
...
T    = 15;        
ODEFUN   = @AntitheticsRNADampedStepddt;
...
title('Step Response of the Antithetic Controller With Buffering');
hold off;
...
%% Dynamics 
function dS = AntitheticsRNADampedStepddt(t, S);
